  ...
  return (
    <AnimateContainer>
      ...
      <p>
        ...
        achievement in Russia. I played for the 2nd FC "Rubin" junior team and
        won numerous championships in my town and state, the Republic of
        Tatarstan. Finally, I graduated from school with a GPA of 4.55/5.
      </p>
      <h3>College</h3>
      <p>
        ...
        courses in college called "WorldSkills Mobile Robotics." I had a growing
        interest in IT science, so I decided to give it a try. At the time, I
        had no specific knowledge about robotics, including soldering, but
        fortunately, it was a team competition, and I wanted to be the
      ...
      <p>
        ...
        Korea's teams were faster and earned more points. I ultimately received
        a bronze medal in the WSI competition in 2019.
      </p>
      <h3>Becoming programmer</h3>
      <p>
        After EuroSkills and WorldSkills, I had the opportunity to meet V.V.
        Putin, though today, it doesn't hold the same significance. Throughout
        2020, I took a mental vacation, but in February 2021, I received an
        invitation to work as a Technical Director for WorldSkills Sakhalin.
        Unfortunately, the offer came with a low salary and limited prospects,
        so I declined. Later, in July, I received another invitation to work as
        a Robotics and Mechatronics teacher at the Moscow Government Education
        Complex. This led me to change my life, move to Moscow, and begin my
        journey towards becoming a real programmer, focusing on the Java
        language. Over the course of a year, I taught students and self-studied
        Java and the Spring Framework. I also started courses on Javarush and
        coached my WorldSkills team in Moscow. Within just one year, I coached
        the winners of the Russia National Competition in Mobile Robotics, using
        Java 11 as the new robotics platform required it. Unfortunately, in
        2022, Russia became involved in a war with Ukraine, and everything
        turned grim. However, I continued my studies. In July 2022, I realized
        that becoming a Junior Java Developer was a valuable path, so I began
        studying TypeScript and React. Thanks to my older brother, who is a
